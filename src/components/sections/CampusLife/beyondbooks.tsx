...
export default function BeyondBooks() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Navigation Tabs */}
      <section className="py-3 px-4 md:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          {/* Curved Tab Navigation */}
          <div className="flex justify-center mb-4">
            <div
              className="flex p-1.5 rounded-full shadow-2xl backdrop-blur-sm border border-white/20"
              style={{
              ...
              {tabs.map((tab, index) => {
                ...
                return (
                  <button
                    ...
                    className={`
                      relative flex items-center gap-1.5 px-3 py-1.5 rounded-full font-semibold transition-all duration-300 text-sm
                      ${
                        activeTab === tab.id
                      ...
                      ${index === 0 ? "ml-0" : "ml-0.5"}
                      ${index === tabs.length - 1 ? "mr-0" : "mr-0.5"}
                    `}
                  >
                    <Icon className="w-3 h-3" />
                    <span className="whitespace-nowrap hidden sm:inline text-sm">
          ...
          <div className="space-y-4">
            ...
            {activeTab === "ignite" && (
              <div className="space-y-4 animate-in fade-in duration-500">
                ...
                >
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">IGNITE</h2>
                  <p className="text-sm text-white/90 font-light">Where Learning Happens beyond the classroom</p>
                  <div className="w-20 h-0.5 bg-white/50 mx-auto mt-3"></div>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-3">
                  <Card className="lg:col-span-2 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0">
                    ...
                    >
                      <h3 className="text-base font-bold text-gray-900 mb-2">What is IGNITE?</h3>
                      <div className="space-y-1.5 text-gray-700 leading-relaxed text-sm">
                        <p>
                  ...
                  <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0">
                    ...
                    >
                      <div className="text-center">
                        ...
                        <h4 className="text-sm font-bold text-white mb-1">Learning Philosophy</h4>
                ...
                {/* Why IGNITE Section */}
                <div
                  className="py-6 px-3 rounded-2xl shadow-lg"
                  style={{ background: "linear-gradient(135deg, #E9DAC1 0%, #F7ECDE 100%)" }}
                >
                  <div className="text-center mb-4">
                    <h3 className="text-xl font-bold mb-1" style={{ color: "#54BAB9" }}>
                      Why IGNITE?
                    </h3>
                    <p className="text-gray-600 text-sm max-w-3xl mx-auto italic">
                      Because we believe that the most powerful learning doesn't always happen at a desk.
                    </p>
                    <div className="w-12 h-0.5 mx-auto mt-2" style={{ backgroundColor: "#54BAB9" }}></div>
                  </div>
                  <div className="text-center mb-3">
                    <p className="text-sm font-medium" style={{ color: "#54BAB9" }}>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-2">
                    <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 overflow-hidden">
                      <div className="h-1.5" style={{ backgroundColor: "#54BAB9" }}></div>
                      <CardContent className="p-2.5 text-center">
                        <div
                          className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-1.5 shadow-lg"
                          style={{ backgroundColor: "#9ED2C6" }}
                        >
                          <Sparkles className="w-5 h-5" style={{ color: "#54BAB9" }} />
                        </div>
                        <h4 className="text-sm font-bold mb-1" style={{ color: "#54BAB9" }}>
                    ...
                    <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 overflow-hidden">
                      <div className="h-1.5" style={{ backgroundColor: "#9ED2C6" }}></div>
                      <CardContent className="p-2.5 text-center">
                        <div
                          className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-1.5 shadow-lg"
                    ...
                    <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 overflow-hidden">
                      <div className="h-1.5" style={{ backgroundColor: "#F7ECDE" }}></div>
                      <CardContent className="p-2.5 text-center">
                        <div
                          className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-1.5 shadow-lg"
                          style={{ backgroundColor: "#E9DAC1" }}
                        >
                          <Heart className="w-5 h-5" style={{ color: "#54BAB9" }} />
                        </div>
                        <h4 className="text-sm font-bold mb-1" style={{ color: "#54BAB9" }}>
                    ...
                    <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0 overflow-hidden">
                      <div className="h-1.5" style={{ backgroundColor: "#E9DAC1" }}></div>
                      <CardContent className="p-2.5 text-center">
                        <div
                          className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-1.5 shadow-lg"
                          style={{ backgroundColor: "#F7ECDE" }}
                        >
                          <School className="w-5 h-5" style={{ color: "#54BAB9" }} />
                        </div>
                        <h4 className="text-sm font-bold mb-1" style={{ color: "#54BAB9" }}>
                ...
                >
                  <div className="text-center mb-4">
                    <h3 className="text-xl font-bold text-white mb-1">How IGNITE Works</h3>
                  ...
                  <div className="grid md:grid-cols-3 gap-2">
                    <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0">
                      <CardContent className="p-2.5 text-center">
                        <div
                          ...
                          style={{ backgroundColor: "#F7ECDE" }}
                        >
                          <BookOpen className="w-5 h-5" style={{ color: "#54BAB9" }} />
                        </div>
                        <h4 className="text-sm font-bold text-gray-900 mb-1">Grade-wise Integration</h4>
                    ...
                    <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0">
                      <CardContent className="p-2.5 text-center">
                        <div
                          ...
                          style={{ backgroundColor: "#E9DAC1" }}
                        >
                          <Users className="w-5 h-5" style={{ color: "#54BAB9" }} />
                        </div>
                        <h4 className="text-sm font-bold text-gray-900 mb-1">Expert Collaboration</h4>
                        <p className="text-gray-700 leading-relaxed text-sm">
                    ...
                    <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-0">
                      <CardContent className="p-2.5 text-center">
                        ...
                        <h4 className="text-sm font-bold text-gray-900 mb-1">Safe & Guided</h4>
                        <p className="text-gray-700 leading-relaxed text-sm">
            ...
            {activeTab === "interschool" && (
              <div className="space-y-4 animate-in fade-in duration-500">
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2 mb-3">
                    ...
                    <div className="text-left">
                      <a
                        ...
                        className="text-sm font-bold hover:underline transition-all duration-300"
                        style={{ color: "#54BAB9" }}
                      >
                  ...
                  <div className="w-20 h-0.5 mx-auto mt-2" style={{ backgroundColor: "#54BAB9" }}></div>
                </div>
                  ...
                  <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 overflow-hidden">
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div>
                          <h3 className="text-base font-bold text-gray-900">BMUN</h3>
                          <p className="text-gray-600 text-sm">Model United Nations</p>
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        ...
                        <div className="grid md:grid-cols-2 gap-1.5 mt-2">
                          <div
                            className="p-2 rounded-lg border shadow-sm text-sm"
                            style={{ backgroundColor: "#F7ECDE" }}
                          >
                            <h4 className="font-semibold text-gray-900 mb-0.5">Six Dynamic Committees</h4>
                          ...
                          <div
                            ...
                            style={{ backgroundColor: "#E9DAC1" }}
                          >
                            <h4 className="font-semibold text-gray-900 mb-0.5">Inter-school Participation</h4>
                            <p className="text-gray-700 text-sm">
                  ...
                  <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 overflow-hidden">
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div>
                          <h3 className="text-base font-bold text-gray-900">ACT</h3>
                          <p className="text-gray-600 text-sm">Environmental Symposium</p>
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        <p className="text-gray-700 leading-relaxed text-sm">
                        ...
                        <div className="grid md:grid-cols-2 gap-1.5 mt-2">
                          <div
                            ...
                            style={{ backgroundColor: "#9ED2C6" }}
                          >
                            <h4 className="font-semibold text-gray-900 mb-0.5">Expert Panel Reviews</h4>
                            <p className="text-gray-700 text-sm">
                          ...
                          <div
                            ...
                            style={{ backgroundColor: "#E9DAC1" }}
                          >
                            <h4 className="font-semibold text-gray-900 mb-0.5">Real-world Impact</h4>
                            <p className="text-gray-700 text-sm">
                  ...
                  <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 overflow-hidden">
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div>
                          <h3 className="text-base font-bold text-gray-900">La Fête</h3>
                          <p className="text-gray-600 text-sm">French Cultural Event</p>
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        <p className="text-gray-700 leading-relaxed text-sm">
                        ...
                        <div className="grid md:grid-cols-2 gap-1.5 mt-2">
                          <div
                            ...
                            style={{ backgroundColor: "#F7ECDE" }}
                          >
                            <h4 className="font-semibold text-gray-900 mb-0.5">Immersive French Experience</h4>
                            <p className="text-gray-700 text-sm">
                          ...
                          <div
                            ...
                            style={{ backgroundColor: "#9ED2C6" }}
                          >
                            <h4 className="font-semibold text-gray-900 mb-0.5">Cultural Celebration</h4>
                            <p className="text-gray-700 text-sm">
            ...
            {activeTab === "intraschool" && (
              <div className="space-y-4 animate-in fade-in duration-500">
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(135deg, #9ED2C6 0%, #54BAB9 100%)" }}
                >
                  <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">IntraSchool Events</h2>
                    ...
                    <CardContent className="p-3 h-full">
                      <div className="flex items-center gap-2 mb-2">
                        <div
                          ...
                          style={{ backgroundColor: "#F7ECDE" }}
                        >
                          <Palette className="w-4 h-4" style={{ color: "#54BAB9" }} />
                        </div>
                        <h3 className="text-base font-bold text-gray-900">Kidsfest</h3>
                      </div>
                      <div className="space-y-1.5">
                        <p className="text-gray-700 leading-relaxed text-sm">
                        ...
                        <div className="p-2 rounded-lg border shadow-sm mt-1.5" style={{ backgroundColor: "#F7ECDE" }}>
                          <h4 className="font-semibold text-gray-900 mb-1 text-sm">Past Themes</h4>
                          <div className="flex flex-wrap gap-1">
                            <span className="px-2 py-0.5 bg-white rounded-full text-sm border shadow-sm">
                              The Lion King
                            </span>
                            <span className="px-2 py-0.5 bg-white rounded-full text-sm border shadow-sm">
                              Cue the Curtains
                    ...
                    <CardContent className="p-3 h-full">
                      <div className="flex items-center gap-2 mb-2">
                        <div
                          ...
                          style={{ backgroundColor: "#9ED2C6" }}
                        >
                          <BookOpen className="w-4 h-4" style={{ color: "#54BAB9" }} />
                        </div>
                        <h3 className="text-base font-bold text-gray-900">Project Day</h3>
                      </div>
                      <div className="space-y-1.5">
                        <p className="text-gray-700 leading-relaxed text-sm">
                        ...
                        <div className="p-2 rounded-lg border shadow-sm mt-1.5" style={{ backgroundColor: "#9ED2C6" }}>
                  ...
                  <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 overflow-hidden">
                    ...
                    <CardContent className="p-3 h-full">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="text-base font-bold text-gray-900">Read-a-thon</h3>
                      </div>
                      <div className="space-y-1.5">
                        <p className="text-gray-700 leading-relaxed text-sm">
                        ...
                        <div className="p-2 rounded-lg border shadow-sm mt-1.5" style={{ backgroundColor: "#E9DAC1" }}>
                          <h4 className="font-semibold text-gray-900 mb-1 text-sm">Special Focus</h4>
                          <div className="space-y-0.5">
                  ...
                  <Card className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-0 overflow-hidden">
                    ...
                    <CardContent className="p-3 h-full">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="text-base font-bold text-gray-900">Leagues</h3>
                      </div>
                      <div className="space-y-1.5">
                        <p className="text-gray-700 leading-relaxed text-sm">
                        ...
                        <div
                          className="p-2 rounded-lg border shadow-sm mt-1.5"
                          style={{ backgroundColor: "#54BAB9", color: "white" }}
                        >
                          <h4 className="font-semibold text-white mb-1 text-sm">Sports Variety</h4>
                          <div className="space-y-0.5">
