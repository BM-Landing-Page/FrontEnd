  ...
  const videos = [
    {
      ...
      description: "Discover the essence of BMIS, a tribute to our community’s pride, harmony, and shared vision.",
      thumbnail: `https://img.youtube.com/vi/ax2Q6k5Rak0/hqdefault.jpg`,
    },
    {
      id: "hf3LXo76IzU",
      title: "Feel the Beat",
      description: "Celebrating togetherness, inspiration, and the journey of learning. ",
