...
export default function USPs() {
  ...
  return (
    <section className="relative min-h-screen bg-white px-6 py-20 lg:px-24 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex gap-4 items-center z-0">
        <div className="w-16 h-1 bg-[#54BAB9]" />
        <div className="w-4 h-4 rounded-full bg-[#9ED2C6]" />
        <div className="w-24 h-1 bg-[#54BAB9]" />
        <div className="w-4 h-4 rounded-full bg-[#E9DAC1]" />
        <div className="w-12 h-1 bg-[#54BAB9]" />
      </div>
