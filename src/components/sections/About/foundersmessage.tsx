            ...
            <Card className="p-8 md:p-12 border border-[#f5e8d9] bg-white shadow-md rounded-xl">
              <div className="space-y-6 text-lg leading-relaxed font-body text-[#333]">
                <div className="bg-gradient-to-br from-[#fff0d9] to-[#fef7ed] p-6 rounded-lg border border-[#f5e8d9] italic font-medium text-[#1e1e1e]">
                  "When people ask what makes Budding Minds so special, I often pause—because it's not just one thing.
                  It's a feeling. A rhythm. A spirit that runs through our corridors."
                </div>
                <p>
                  Perhaps it begins with the warmth that greets you the moment you step onto our campus—not just in the
                  cozy, thoughtfully designed learning spaces, but in the genuine smiles of our staff, the gentle hum of
                  curiosity in every classroom, and the small but powerful moments of connection that fill each day.
                </p>
                <p>
                  It could be the extraordinary experiences we quietly weave into everyday learning—those unplanned
                  sparks of joy, discovery, and challenge that leave lasting imprints on young hearts. Or maybe it's the
                  way our school environment adapts and grows—just like our learners do—to stay in step with a rapidly
                  changing world.
                </p>
                ...
                <p>
                  As a close-knit community of students, facilitators, and parents, we build strong relationships,
                  grounded in trust, support, and shared purpose.
                </p>
                <p>
                  At Budding Minds, we see every child. We take the time to understand them, to honour their uniqueness,
                  and to offer them the freedom to ask questions, explore widely, and to take charge of their own
                  learning journeys. We believe true learning goes beyond academics—it's about nurturing character,
                  confidence, and compassion.
                </p>
                <p>
                  One of the proudest moments in our recent journey has been witnessing our student council step
                  forward—not just as event planners or voices of the student body—but as collaborators in creating a
                  culture of belonging. Their partnership with our facilitators shows that our vision of shaping student
                  leaders is not just a dream—it's happening, here and now.
                </p>
                <p>
